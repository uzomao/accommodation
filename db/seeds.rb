...
image7 = Picture.create({
  image: File.new(File.join(Rails.root, "/app/assets/images/seed/7.jpg")),
...
image8 = Picture.create({
  image: File.new(File.join(Rails.root, "/app/assets/images/seed/8.jpg")),
...
image9 = Picture.create({
  image: File.new(File.join(Rails.root, "/app/assets/images/seed/9.jpg")),
